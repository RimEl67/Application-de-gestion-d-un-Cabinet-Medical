...
CREATE TABLE `his_patient_transfers` (
  ...
  `t_Cabinet` varchar(200) DEFAULT NULL,
...
INSERT INTO `his_patient_transfers` (`t_id`, `t_Cabinet`, `t_date`, `t_pat_name`, `t_pat_number`, `t_status`) VALUES
(1, 'Kenyatta National Cabinet', '2020-01-11', 'Mart Developers', '9KXPM', 'Success');
